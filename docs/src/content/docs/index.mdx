...
Private sites use wisp.place storage instead. They are access-controlled and never written to your PDS or the firehose.
...
- [Private sites](/private-sites) — upload and share access-controlled sites
